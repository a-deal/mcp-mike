...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "Use quiz_me to do a spaced repetition quiz. Four tracks available: "
        "'claude' (how to use Claude Desktop), 'cli' (bridge from Desktop to Claude Code CLI), "
        "'learnair' (domain knowledge for the veteran AI supervision curriculum), "
